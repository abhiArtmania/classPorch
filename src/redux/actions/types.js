...
export const GET_STUDENT_FAQ_SUCCESS = 'GET_STUDENT_FAQ_SUCCESS';
export const GET_TUTOR_FAQ_SUCCESS = 'GET_TUTOR_FAQ_SUCCESS';
export const GET_TECHNICAL_FAQ_SUCCESS = 'GET_TECHNICAL_FAQ_SUCCESS';
export const GET_SEARCH_FAQ_SUCCESS = 'GET_SEARCH_FAQ_SUCCESS';
export const SET_SEARCH_FAQ = 'SET_SEARCH_FAQ';
export const GET_CATEGORIES = 'GET_CATEGORIES';
export const SUBMIT_TICKET_SUCCESS = 'SUBMIT_TICKET_SUCCESS';
export const SUBMIT_REVIEW = 'SUBMIT_REVIEW';
export const SUBMIT_TUTOR_REVIEW = 'SUBMIT_TUTOR_REVIEW';
