    ...
    render() {
        ...
        return (
            <Grid className='sign-up-about-section-body'>
                ...
                <Grid.Row centered>
                    <Grid.Column width={12} textAlign='left'>
                        <Input fluid name='age' type='number' error label="Age" placeholder='Age' min="6"
                            max="99" />
                    </Grid.Column>
                </Grid.Row>
                {renderParentInfo}
                <Grid.Row centered>
                    <Grid.Column width={6} textAlign='left'>
                        <Select label={'Country'} labeled={true} fluid name='country' onChange={this.props.onChange} placeholder='Select your country' options={CountryList} required search />
