        ...
        return educationalAttributes.map((education,i) => {
            ...
            return(
                <Grid.Row stretched columns={3} centered key={i} >
                    ...
                    {                   
                        mode==='edit'?
                         <Dropdown placeholder='Select Grade' fluid search selection className='profile-text' 
                            style={{height:'50px',borderRadius:0, fontSize:'1.2em'}}
                            onChange={this.onChangeField.bind(this,i,'edit', 'grade')} value={education['grade']}
                            options={this.gradesList}/>
                        :
                        <div className='profile-text' style={{textTransform:"capitalize"}} > {education['grade']} </div>
                    }
